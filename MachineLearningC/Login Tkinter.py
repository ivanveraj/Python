...
#JAVIER MAURICIO CLAVIJO PÉREZ - 20191732015
#GERARDO ANDRÉS MUNERA RODRÍGUEZ – 20191732001
...
def ventana_inicio():
    ...
    ventana_principal.title("Programa de ajustes Topograficos")#TITULO DE LA VENTANA
    Label(text="Eliga su opción", bg="LightGreen", width="300", height="2", font=("Calibri", 13)).pack()
    Label(text="").pack()
    Button(text="Ingresar", height="2", width="30", bg=pestas_color, command=login).pack()
    Label(text="").pack()
...
def login () :
    ...
    Label (ventana_login, text="") .pack()
    Button (ventana_login, text="Ingresar", width=10, height=1, command = ventana_login) .pack()
